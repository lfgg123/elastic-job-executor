...
public class JobScheduler {
    ...
    //修改
    public JobScheduler(final CoordinatorRegistryCenter regCenter, final LiteJobConfiguration liteJobConfig, final Class<?> jobClazz, final JobEventConfiguration jobEventConfig, final ElasticJobListener... elasticJobListeners) {
        this(regCenter, liteJobConfig, new JobEventBus(jobEventConfig), elasticJobListeners);
        this.jobClazz = jobClazz;
    }

    public JobScheduler(final CoordinatorRegistryCenter regCenter, final LiteJobConfiguration liteJobConfig, final Class<?> jobClazz, final ElasticJobListener... elasticJobListeners) {
        this(regCenter, liteJobConfig, new JobEventBus(), elasticJobListeners);
        this.jobClazz = jobClazz;
    }
        ...
        if (elasticJobInstance.isPresent()) {
            ...
            try {
                ...
                try {
                    ...
                    result.getJobDataMap().put(ELASTIC_JOB_DATA_MAP_KEY, clazz.newInstance());
                } catch (final ClassNotFoundException e) {
                    result.getJobDataMap().put(ELASTIC_JOB_DATA_MAP_KEY, jobClazz.newInstance());
                }
